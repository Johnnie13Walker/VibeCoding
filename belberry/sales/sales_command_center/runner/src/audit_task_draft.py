...
- Пункт 1 = ОТКРЫТИЕ: одна острая фраза с небанальным углом по этой сделке (из real_cause /
  what_would_save_it / слов клиента). Последний пункт = конкретный следующий шаг + 2 слота времени.

ДУМАЙ перед этим (про себя, в вывод не пиши): какой ОДИН неочевидный угол по этой сделке
цепляет? Заход должен быть разным каждый раз — твоя выдумка, не шаблон.
