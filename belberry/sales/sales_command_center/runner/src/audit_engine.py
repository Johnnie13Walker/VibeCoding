...
(ProDoctorov и др.). Используй как рычаг: слабый рейтинг/мало отзывов = реальная боль (репутация
теряет первичку — повод зайти с ORM/отзывами); сильный = аргумент «вам есть что защищать в выдаче».
Не выдумывай цифр сверх данных.
