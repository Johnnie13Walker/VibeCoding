...
from . import analyze_llm, bx_client, call_audio
...
Верни строго JSON без markdown:
{
  ...
  "key_quotes": [{"date": "ДД.ММ", "speaker": "кто", "quote": "дословная цитата (можно из расшифровки звонка)", "why": "что показывает"}],
  "call_analysis": [{"date": "ДД.ММ", "summary": "о чём говорили", "client_tone": "тон/настрой клиента", "objections": ["возражения из разговора"], "manager_quality": "как отработал менеджер", "commitment": "что клиент пообещал/не пообещал"}],
