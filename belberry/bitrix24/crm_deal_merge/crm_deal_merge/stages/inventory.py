...
def run(
    ...
    *,
    ...
    for row_number, group in targets:
        records = _collect_group_inventory(bx, group.company_id, group.loser_ids, include_sp=include_sp)
        new_records = [
            r for r in records
    ...
    return {"processed": processed, "records": total, "types": dict(counts), "include_sp": include_sp}
...
def _collect_group_inventory(
    ...
    *,
    ...
    for loser_id in loser_ids:
        print(f"[inventory]   loser #{loser_id}: собираю связи")
