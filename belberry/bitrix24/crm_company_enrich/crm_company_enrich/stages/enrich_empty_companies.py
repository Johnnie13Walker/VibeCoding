...
def run_apply(*, dry_run: bool = True, limit: int | None = None, throttle_s: float = CCE_APPLY_SLEEP_S) -> dict:
    ...
    for idx, row in enumerate(targets, start=1):
        ...
        # Контаминация: при кривом матче цели (нечёткий _find_company_by_url или
        # устаревший ворклист) сюда попадала компания со своим правильным ИНН,
        # и run_apply дописывал ей чужой — две организации в одной карточке.
        already_valid_other = [
            r for r in existing
