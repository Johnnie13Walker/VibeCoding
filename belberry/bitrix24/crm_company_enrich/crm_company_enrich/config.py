...
TELEMARKETING_REVIVED_FROM_LOSE_STAGE = "C50:LOSE"
TELEMARKETING_REVIVE_TARGET_STAGE = "C50:NEW"
TELEMARKETING_REVIVE_SOURCE_ID = "12"
...
HOLD_REASON_DUPLICATE = "8544"         # Дубль
...
HOLD_MARKER_DESC_FIELD = LAST_AUTO_ACTION_DESC_FIELD

TELEMARKETING_DEDUPE_SHEET_ID = os.environ.get(
    "CCE_TELEMARKETING_DEDUPE_SHEET_ID",
...
# REG_ADDRESS_REGION -> enum ID поля COMPANY_UF_REGION. Ключи соответствуют
# нормализованным значениям без «область», «республика», «край», «г.»,
# скобочных уточнений и суффиксов после тире.
COMPANY_REGION_ENUM_MAP: dict[str, str] = {
    "адыгея": "9262",
    "алтай": "9264",
    "алтайский": "9170",
    "амурская": "9172",
    ...
    "дагестан": "9270",
    "донецкая": "9190",
    "еврейская автономная": "9192",
    "забайкальский": "9194",
    "запорожская": "9196",
    "ивановская": "9198",
    "ингушетия": "9272",
    "иркутская": "9200",
    "кабардино-балкарская": "9202",
    "калининградская": "9204",
    "калмыкия": "9274",
    "калужская": "9206",
    "камчатский": "9208",
    "карачаево-черкесская": "9210",
    "карелия": "9276",
    "кемеровская": "9212",
    "кировская": "9214",
    "коми": "9278",
...
DEAL_UF_REGION = "UF_CRM_5E79DD26F08C9"            # Регион (строка)
