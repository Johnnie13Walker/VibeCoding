...
const noteRow = row("Логика", 'Когортный слой обычно считает по месяцу создания сделки; для «Телемаркетинг» месяц обращения берётся по полю «Дата встречи». Событийный слой считает лиды телемаркетинга по проведённым встречам, остальные этапы — по первому входу в этап.');
row("");
...
row('=HYPERLINK("https://docs.google.com/spreadsheets/d/11LWdg8HGOHyDh3QlEEJlD4yfrMTVkUAzEdVxnyvfRZM/edit#gid=146952454";"Сделки")', "Детальный список сделок отчётного контура");
