...
ROOT_DIR="${MARKETING_DASHBOARD_RUNTIME_ROOT:-/Users/pro2kuror/Desktop/VibeCoding/belberry/marketing_dashboard}"
ENGINEER_ENV="${MARKETING_DASHBOARD_ENGINEER_ENV:-${SOURCE_ROOT}/.env.integrations}"
SA_SOURCE="${MARKETING_GOOGLE_SERVICE_ACCOUNT_JSON:-${GOOGLE_SERVICE_ACCOUNT_JSON:-/Users/pro2kuror/.config/vibecoding/assistant/secrets/finance-director-sheets-903611b799c3.json}}"
SA_RUNTIME="${MARKETING_DASHBOARD_SERVICE_ACCOUNT_RUNTIME_PATH:-/Users/pro2kuror/.config/vibecoding/assistant/secrets/finance-director-sheets-903611b799c3.json}"
...
copy_script() {
  local name="$1"
  local source_file="${SOURCE_ROOT}/scripts/${name}"
  local target_file="${ROOT_DIR}/scripts/${name}"
...
copy_script "check_marketing_dashboard_month_literals.mjs"
copy_script "marketing_dashboard_period.mjs"
