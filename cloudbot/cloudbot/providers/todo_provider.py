"""Todo provider: адаптер к существующему JS provider todoist."""
...
LEGACY_MODULE = "cloudbot/providers/todoist/index.js"
...
def healthcheck(config: dict[str, Any] | None = None) -> dict[str, Any]:
    try:
        ...
        return {"provider": "todo", "ok": False, "error": str(error)}
