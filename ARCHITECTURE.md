...
- Пример: `larisa_ivanovna` собирает дневной brief, задачи, встречи и погодный блок через provider-слой.
...
- Workflow `day_briefing` вызывает `agents/larisa_ivanovna`, который:
